...
% Environmental data ------------------------------------------------------
filename_Twater = 'Environmental_Data/TEMPERARVO_ACQUA_RAW.DAT';
filename_Hwater = 'Environmental_Data/IDRO_RAW.DAT';
...
window_size = 5;   % number of epochs to be used to calculate the moving mean
...
PS_id = 3;   % corresponding to PS 24
...
data_pred_SAR = coeffs(1) + coeffs(2) * data_Hwater + coeffs(3) * data_Twater;
